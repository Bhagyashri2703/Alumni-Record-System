...
//        }
    ...
    public void forgetPass(String email) {
        ...
        String url = "https://dnpcoealumni.horizonapp.xyz/ForgetPass.php?Email="+email.trim();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                            Toast.makeText(SLogin.this,"Response:"+response,Toast.LENGTH_LONG).show();
                            hud.dismiss();
                    }
                },
                new Response.ErrorListener() {
...
//        }
    ...
    public void forgetPass(View view) {
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(SLogin.this);
        dlg.setTitle("Forget Password.");
        dlg.setMessage("Please Enter the Registered EMail ID.");
        View v = getLayoutInflater().inflate(R.layout.forgetpass_input,null);
        dlg.setView(v);
        EditText txtForgetPassEMail = v.findViewById(R.id.txtForgetPassEMail);
        dlg.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(SLogin.this, ""+txtForgetPassEMail.getText(), Toast.LENGTH_SHORT).show();
                forgetPass(txtForgetPassEMail.getText().toString());
            }
        });
