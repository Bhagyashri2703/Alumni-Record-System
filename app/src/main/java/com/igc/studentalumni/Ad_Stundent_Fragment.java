...
public class Ad_Stundent_Fragment extends Fragment
{
    ...
    class MyClass extends RecyclerView.Adapter<MyClass.NewHolder>
    {
        ...
        public NewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
        {
            ...
            View v =  inflater.inflate(R.layout.ad_student_design_exp,parent,false);
...
//            holder.txtPNR.setText(lstPNR.get(position));
            holder.txtSName.setText(lstName.get(position));
            holder.txtDeptBranchBatch.setText(lstDept.get(position)+ " " + lstBranch.get(position) + " [ " + lstBatch.get(position) + " ]");
            holder.txtCollege.setText(lstCollege.get(position));
            holder.txtPNRNo.setText(lstPNR.get(position));
        ...
        class NewHolder extends RecyclerView.ViewHolder
        {
            ...
            TextView txtSName,txtDeptBranchBatch,txtPNRNo,txtCollege;
...
//                txtSBranch = itemView.findViewById(R.id.txtSBranch);
                txtSName = itemView.findViewById(R.id.txtSName);
                txtDeptBranchBatch = itemView.findViewById(R.id.txtDeptBranchBatch);
                txtCollege = itemView.findViewById(R.id.txtCollege);
                txtPNRNo = itemView.findViewById(R.id.txtPNRNo);
            }
        }
    }
    private void intentBundle(@NonNull MyClass.NewHolder holder, int position)
    {
        ...
        i.putExtra("College",lstCollege.get(position));
